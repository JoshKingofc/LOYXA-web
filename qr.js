              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "BOYXA-XD~" + string_session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        let desc = `*Hey there, BOYKA-XD User!* 👋🏻

Thanks for using *BOYKA-XD* — your session has been successfully created!
...
for any help dm https://wa.me/qr/52ZREUHY5TXVG1 ✌🏻`;
                        await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
title: "𝙇𝙏𝘿-𝙇𝙀𝙂𝙄𝙏𝘽𓃵 -🅇🄳 D 𝕮𝖔𝖓𝖓𝖊𝖈𝖙𝖊𝖉",
